...
<? $sqlmodel=mysql_query("select * from tbl_products where cateid='".$get_serie['cate_id']."' and published=1 and lang = 1 order by id");
...
<? $sql_model=mysql_query("select * from tbl_products where cateid='".$series['cate_id']."' and lang = 1  and published=1 order by id");
