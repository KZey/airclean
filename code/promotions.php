...
<h3 style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#fff; padding:25px 0px 0 20px; ">Promotions</h3>
</div>
</div>
...
<div class="bodyleftContainer1"><h1>Promotions</h1><?=$cmsdata['page_content'];?></div>
<div class="clear"></div>
</div>
