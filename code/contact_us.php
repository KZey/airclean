...
<p style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#21b1cb; padding:20px 0 0 20px;">Contact Us</p>
...
<div class="bodyleftContainer1"><h1>Contact Us</h1><?=$cmsdata['page_content'];?></div>
<div class="clear"></div>
</div>
