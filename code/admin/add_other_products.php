...
mysql_query("insert into tbl_other_products SET product_name='".$TR_Product_Name."',regular_price='".$TR_Regular_Price."',our_price='".$Our_Price."',image='".$file."',description='".$TR_Description."',published='".$TR_Published."', lang = 1");
