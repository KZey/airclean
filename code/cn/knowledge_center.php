...
$cmsdata=pagedata('id','15','tbl_cms');
...
<h3 style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#115464; padding:25px 0 0 20px;">资讯中心</h3>
</div>
</div>
...
<? if($article['url']){?>
<a href="<?=generate_web_link($article['url']);?>" target="_blank">查看文章</a>
<? }else{?>
<a href="article_detail.php?aid=<?=$article['id'];?>">查看文章</a>
<? }?>
</div>
<? 
$i++;
	...
	echo '<div align="center"><br /><br /><br />暂无资讯信息.<br /><br /><br /></div>';
}
?>
<div class="clear"></div>
