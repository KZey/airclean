...
$cmsdata=pagedata('id','16','tbl_cms');
...
<h3 style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:fff; padding:25px 0px 0 20px; ">促销信息</h3>
</div>
</div>
