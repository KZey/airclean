...
$cmsdata=pagedata('id','13','tbl_cms');
...
<p style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#21b1cb; padding:20px 0 0 20px;">联系我们</p>
