...
$cmsdata=pagedata('id','11','tbl_cms');
...
<h3 style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#fff; padding:25px 0 0 20px;">其他产品</h3>
</div>
</div>
...
<h1>其他产品</h1>
<?
$sql_model=mysql_query("select * from tbl_other_products where published=1 and lang=2 order by id");
$i=1;
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left" valign="top"> <p><h3><!--<a href="blueair_purifiers_other_product.php?product=<?//=$getmodel['id'];?>">--><?=$getmodel['product_name'];?>:-</h3><?=$getmodel['description'];?></p><br/>
      <strong>市场价</strong>:- <?=$getmodel['regular_price'];?>元<br />
      <strong style='color:red'>优惠价</strong><span style='color:red'>:- <? if($getmodel['our_price']>0){ echo $getmodel['our_price'];}else{ echo "XXX";}?>元</span></td>
  </tr>
</table>
