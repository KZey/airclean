...
<h3 style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#fff; padding:25px 0 0 20px;">Service Packages</h3>
</div>
</div>
...
<div class="bodyleftContainer1"><?=$cmsdata['page_content'];?></div>
<div class="clear"></div>
</div>
