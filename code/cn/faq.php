...
$cmsdata=pagedata('id','12','tbl_cms');
...
<h3 style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#fff; padding:25px 0 0 20px;">常见问题</h3>
</div>
</div>
