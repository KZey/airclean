...
<!--<p style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:17px; color:#21b1cb; padding:20px 0 0 20px;">Contact Us</p>-->
<h3 style="font-family:'ZurichCnBTRegular', Arial, Helvetica, sans-serif; font-size:25px; color:#fff; padding:25px 0 0 20px;">Frequently Asked Questions</h3>
</div>
</div>
...
<div class="bodyleftContainer1"><h1>Frequently Asked Questions</h1><?=$cmsdata['page_content'];?></div>
<div class="clear"></div>
</div>
